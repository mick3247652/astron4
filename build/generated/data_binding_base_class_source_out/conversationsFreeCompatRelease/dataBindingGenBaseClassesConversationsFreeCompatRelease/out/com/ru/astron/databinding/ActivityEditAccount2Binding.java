...
import com.ru.astron.ui.widget.TextInputEditText;
import java.lang.Deprecated;
import java.lang.Object;

public abstract class ActivityEditAccount2Binding extends ViewDataBinding {
  @NonNull
  ...
  protected ActivityEditAccount2Binding(Object _bindingComponent, View _root, int _localFieldCount,
      ...
      TextView sessionEst, CardView stats, TextView textView, View toolbar, TextView yourName,
  ...
  @NonNull
  public static ActivityEditAccount2Binding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_edit_account2, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityEditAccount2Binding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityEditAccount2Binding>inflateInternal(inflater, com.ru.astron.R.layout.activity_edit_account2, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_edit_account2, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityEditAccount2Binding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityEditAccount2Binding>inflateInternal(inflater, com.ru.astron.R.layout.activity_edit_account2, null, false, component);
  }

  public static ActivityEditAccount2Binding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static ActivityEditAccount2Binding bind(@NonNull View view, @Nullable Object component) {
    return (ActivityEditAccount2Binding)bind(component, view, com.ru.astron.R.layout.activity_edit_account2);
  }
}
