...
public final class Config {
    ...
    public static final Jid BUG_REPORTS = Jid.of("mick@astron.online");


    public static final String DOMAIN_LOCK = null; //only allow account creation for this domain
    public static final String MAGIC_CREATE_DOMAIN = "astron.online";
    public static final String QUICKSY_DOMAIN = "astron.online";
