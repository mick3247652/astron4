...
import com.app.astron.databinding.FragmentConversationBinding;
...
import com.app.astron.entities.MucOptions.User;
import com.app.astron.entities.Presence;
import com.app.astron.entities.ReadByMarker;
import com.app.astron.entities.Transferable;
import com.app.astron.entities.TransferablePlaceholder;
import com.app.astron.http.HttpDownloadConnection;
import com.app.astron.persistance.FileBackend;
import com.app.astron.services.MessageArchiveService;
import com.app.astron.services.QuickConversationsService;
import com.app.astron.services.XmppConnectionService;
import com.app.astron.ui.adapter.MediaPreviewAdapter;
import com.app.astron.ui.adapter.MessageAdapter;
import com.app.astron.ui.util.ActivityResult;
import com.app.astron.ui.util.Attachment;
import com.app.astron.ui.util.ConversationMenuConfigurator;
import com.app.astron.ui.util.DateSeparator;
import com.app.astron.ui.util.EditMessageActionModeCallback;
import com.app.astron.ui.util.ListViewUtils;
import com.app.astron.ui.util.MenuDoubleTabUtil;
import com.app.astron.ui.util.MucDetailsContextMenuHelper;
import com.app.astron.ui.util.PendingItem;
import com.app.astron.ui.util.PresenceSelector;
import com.app.astron.ui.util.ScrollState;
import com.app.astron.ui.util.SendButtonAction;
import com.app.astron.ui.util.SendButtonTool;
import com.app.astron.ui.util.ShareUtil;
import com.app.astron.ui.util.ViewUtil;
...
import com.app.astron.utils.GeoHelper;
import com.app.astron.utils.MessageUtils;
import com.app.astron.utils.NickValidityChecker;
import com.app.astron.utils.Patterns;
import com.app.astron.utils.QuickLoader;
import com.app.astron.utils.StylingHelper;
import com.app.astron.utils.TimeframeUtils;
import com.app.astron.utils.UIHelper;
import com.app.astron.xmpp.XmppConnection;
import com.app.astron.xmpp.chatstate.ChatState;
import com.app.astron.xmpp.jingle.JingleConnection;
import rocks.xmpp.addr.Jid;

import static com.app.astron.ui.XmppActivity.EXTRA_ACCOUNT;
import static com.app.astron.ui.XmppActivity.REQUEST_INVITE_TO_CONVERSATION;
import static com.app.astron.ui.util.SoftKeyboardUtils.hideSoftKeyboard;
import static com.app.astron.utils.PermissionUtils.allGranted;
import static com.app.astron.utils.PermissionUtils.getFirstDenied;
import static com.app.astron.utils.PermissionUtils.writeGranted;
